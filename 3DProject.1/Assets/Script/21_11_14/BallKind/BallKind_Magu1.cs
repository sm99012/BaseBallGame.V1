...
public class BallKind_Magu1 : BallKind
{
    public BallKind_Magu1()
    {
        m_sName = "Magu1";
    }
    ...
    public override void Move()
    {
        ...
        if (Ball.BInstance.m_eBallState == BallManager.E_BALL_STATE.THROW)
        {
            if (Move_Pitch == false)
            {
                ...
                Ball.BInstance.m_gGravity.m_vCurrentForce += new Vector3(-0.08f, 0.05f, 0);
                Debug.Log("m_vBallProgress1: " + m_vBallProgress1);
            }
            if (Ball.BInstance.m_bBallProgressSection1 == true && m_bBPS1 == false)
            {
                m_bBPS1 = true;
                Ball.BInstance.m_gGravity.m_vCurrentForce = new Vector3(0.08f, 0.1f, 0.3f);
            }
